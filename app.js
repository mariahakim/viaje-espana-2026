const details = {
  ...
  london: {
    icon: "✈", title: "Santander ↔ Londres (Stansted)", subtitle: "Ryanair · escapada de Maria del 3 al 7 de agosto.",
    rows: [["Estado", "Confirmado"], ["Reserva", '<span class="sensitive">MU3TXY</span>'], ["Pasajera", "Maria Hakim Morfin"], ["Ida", "FR2613 · 3 agosto 2026 · 15:50 SDR → 16:40 STN"], ["Regreso", "FR2612 · 7 agosto 2026 · 18:15 STN → 21:15 SDR"], ["Asientos", "Ida 16A · regreso 12F"], ["Equipaje", "Prioridad & 2 piezas de equipaje de mano"]],
    links: [["Gestionar reserva", "https://www.ryanair.com/es/es/trip/manage/BookingId:950025548?utm_source=itinerary-email&utm_medium=email"], ["Ver comprobante", "./public/documents/reserva-ryanair-londres.png"]]
  },
  "return-home": {
...
const tripActivities = [
  { title: "Comienza la aventura", detail: "Aeroméxico AM 1 · 17:25 MEX → 12:35 MAD", start: "2026-07-16T17:25:00-06:00", end: "2026-07-17T12:35:00+02:00" },
  { title: "One Shot Fortuny", detail: "Check-in Madrid · 17–20 julio", start: "2026-07-17T15:00:00+02:00", end: "2026-07-20T10:00:00+02:00" },
  { title: "Tren Madrid → Málaga", detail: "Iryo 06118 · 11:55 Atocha → 14:39 María Zambrano", start: "2026-07-20T11:55:00+02:00", end: "2026-07-20T14:39:00+02:00" },
  { title: "Casa de Iker & Sofía", detail: "Málaga · 20–25 julio", start: "2026-07-20T15:00:00+02:00", end: "2026-07-25T12:00:00+02:00" },
  { title: "Vuelo Málaga → Palma", detail: "Ryanair FR5677 · 19:35 AGP → 21:05 PMI", start: "2026-07-25T19:35:00+02:00", end: "2026-07-25T21:05:00+02:00" },
  { title: "Recoger coche en Mallorca", detail: "Wiber · Palma de Mallorca Aeropuerto · 22:00", start: "2026-07-25T22:00:00+02:00", end: "2026-07-25T23:00:00+02:00" },
  { title: "Universal Hotel Aquamarin", detail: "Sant Elm · 25–28 julio", start: "2026-07-25T22:30:00+02:00", end: "2026-07-28T07:00:00+02:00" },
  { title: "Devolver coche en Mallorca", detail: "Wiber · Palma de Mallorca Aeropuerto · 07:30", start: "2026-07-28T07:30:00+02:00", end: "2026-07-28T08:00:00+02:00" },
  { title: "Ferry Alcúdia → Ciutadella", detail: "Balearia Jaume III · 08:30 → 09:45", start: "2026-07-28T08:30:00+02:00", end: "2026-07-28T09:45:00+02:00" },
  { title: "Recoger coche en Menorca", detail: "Owners Cars · Cala'n Bosch · 10:30", start: "2026-07-28T10:30:00+02:00", end: "2026-07-28T11:00:00+02:00" },
  { title: "Caramelo Marina Cala'n Bosch", detail: "Menorca · 28 julio–1 agosto", start: "2026-07-28T15:00:00+02:00", end: "2026-08-01T09:00:00+02:00" },
  { title: "Devolver coche en Menorca", detail: "Owners Cars · Cala'n Bosch · 09:00", start: "2026-08-01T09:00:00+02:00", end: "2026-08-01T09:20:00+02:00" },
  { title: "Vuelo Menorca → Santander", detail: "Volotea V73872 · 09:45 MAH → 11:25 SDR", start: "2026-08-01T09:45:00+02:00", end: "2026-08-01T11:25:00+02:00" },
  { title: "Recoger coche en Santander", detail: "Hertz · Santander Aeropuerto · 13:00", start: "2026-08-01T13:00:00+02:00", end: "2026-08-01T13:30:00+02:00" },
  { title: "Departamento en Llanes", detail: "Av. de la Paz 3 · 1–18 agosto", start: "2026-08-01T16:00:00+02:00", end: "2026-08-18T10:00:00+02:00" },
  { title: "Vuelo Santander → Londres", detail: "Maria · Ryanair FR2613 · 15:50 SDR → 16:40 STN", start: "2026-08-03T15:50:00+02:00", end: "2026-08-03T16:40:00+01:00" },
  { title: "Regreso Londres → Santander", detail: "Maria · Ryanair FR2612 · 18:15 STN → 21:15 SDR", start: "2026-08-07T18:15:00+01:00", end: "2026-08-07T21:15:00+02:00" },
  { title: "Devolver coche en Santander", detail: "Hertz · Santander Aeropuerto · 13:00", start: "2026-08-18T13:00:00+02:00", end: "2026-08-18T13:30:00+02:00" },
  { title: "Tren Santander → Madrid", detail: "Pendiente de reservar · 18 agosto", start: "2026-08-18T14:00:00+02:00", end: "2026-08-18T18:00:00+02:00" },
  { title: "Vuelo Madrid → CDMX", detail: "Aeroméxico AM 2 · por confirmar · 10:45 MAD → 14:20 MEX", start: "2026-08-18T10:45:00+02:00", end: "2026-08-18T14:20:00-06:00" }
];
const monthLabel = date => date.toLocaleDateString("es-MX", { month: "short" }).replace(".", "").toUpperCase();
const updateNextActivity = () => {
  const now = new Date();
  const activities = tripActivities
    .map(activity => ({ ...activity, startsAt: new Date(activity.start), endsAt: new Date(activity.end) }))
    .sort((a, b) => a.startsAt - b.startsAt);
  const current = activities.filter(activity => now >= activity.startsAt && now <= activity.endsAt).at(-1);
  const upcoming = activities.find(activity => activity.startsAt > now);
  const selected = current || upcoming || activities.at(-1);
  const startsAt = selected.startsAt;
  document.querySelector("#nextEyebrow").textContent = current ? "AHORA EN EL VIAJE" : upcoming ? "PRÓXIMA ACTIVIDAD" : "VIAJE COMPLETO";
  document.querySelector("#next-title").textContent = selected.title;
  document.querySelector("#nextDetail").textContent = selected.detail;
  document.querySelector("#nextDay").textContent = String(startsAt.getDate()).padStart(2, "0");
  document.querySelector("#nextMonth").textContent = monthLabel(startsAt);
};
updateNextActivity();
setInterval(updateNextActivity, 60 * 1000);
...
const linkMarkup = (label, href, index = 0) => {
  ...
  const externalAttrs = isLocalDocument(href) ? ' target="_blank"' : ' target="_blank" rel="noreferrer"';
...
const SUPABASE_REST_URL = "https://iauzxzwvodgmccpundnk.supabase.co/rest/v1";
const SUPABASE_KEY = "sb_publishable_YBm1HgmAsRUk0NH6gwYx2g_ZyD-7grT";
const remoteHeaders = {
  apikey: SUPABASE_KEY,
...
let remotePlacesBusy = false;
let remoteExpensesBusy = false;
...
const remoteSelect = table => remoteRequest(`${table}?select=*&order=created_at.desc`);
const remoteInsert = (table, payload) => remoteRequest(table, {
  method: "POST",
  headers: { Prefer: "return=representation" },
  body: JSON.stringify(payload)
}).then(rows => rows?.[0]);
const remoteUpdate = (table, id, payload) => remoteRequest(`${table}?id=eq.${encodeURIComponent(id)}`, {
  method: "PATCH",
  headers: { Prefer: "return=representation" },
  body: JSON.stringify({ ...payload, updated_at: new Date().toISOString() })
}).then(rows => rows?.[0]);
const remoteDelete = (table, id) => remoteRequest(`${table}?id=eq.${encodeURIComponent(id)}`, { method: "DELETE" });
...
const fromPlaceRecord = record => ({
  id: record.id,
  title: record.title || "",
  destination: record.destination || "Otro",
  category: normalizePlaceCategory(record.category || "otro"),
  maps: record.maps || "",
  note: record.note || "",
...
const loadRemotePlaces = async ({ seedLocal = false } = {}) => {
  if (remotePlacesBusy) return;
  try {
    remotePlacesBusy = true;
    const rows = await remoteSelect("places");
    remoteOnline = true;
    const localOnly = seedLocal && Array.isArray(rows) ? places.filter(place => !isUuid(place.id)) : [];
    if (localOnly.length) {
      const seeded = [];
      for (const place of localOnly) {
        const created = await remoteInsert("places", toPlaceRecord(place));
        if (created) seeded.push(fromPlaceRecord(created));
      }
      places = [...seeded, ...rows.map(fromPlaceRecord)];
    } else if (Array.isArray(rows)) {
      places = rows.map(fromPlaceRecord);
    }
    renderPlaces();
  } catch (error) {
    remoteOnline = false;
  } finally {
    remotePlacesBusy = false;
  }
};
const savePlaceRemote = async payload => {
  if (remoteOnline) {
    const created = await remoteInsert("places", toPlaceRecord(payload));
    if (created) return fromPlaceRecord(created);
  }
  return { id: localId(), ...payload };
};
const updatePlaceRemote = async (id, payload) => {
  if (remoteOnline && isUuid(id)) {
    const updated = await remoteUpdate("places", id, toPlaceRecord(payload));
    if (updated) return fromPlaceRecord(updated);
  }
  return { id, ...payload };
};
const deletePlaceRemote = async id => {
  if (remoteOnline && isUuid(id)) await remoteDelete("places", id);
};
...
placeForm.addEventListener("submit", async event => {
  ...
  try {
    if (placeId.value) {
      const saved = await updatePlaceRemote(placeId.value, payload);
      places = places.map(place => place.id === placeId.value ? saved : place);
    } else {
      const saved = await savePlaceRemote(payload);
      places.unshift(saved);
    }
    resetPlaceForm();
    renderPlaces();
  } catch {
    placeAutoPreview.textContent = "No pude guardar en la base compartida. Intenta otra vez.";
  } finally {
...
placeList.addEventListener("click", event => {
  ...
  if (deleteButton) {
    ...
    deletePlaceRemote(id)
      .then(() => {
        places = places.filter(place => place.id !== id);
        if (placeId.value === id) resetPlaceForm();
        renderPlaces();
      })
      .catch(() => {
...
resetPlaceForm();
renderPlaces();
loadRemotePlaces({ seedLocal: true });
setInterval(() => loadRemotePlaces(), 8000);
...
const fromExpenseRecord = record => ({
  id: record.id,
  title: record.title || "",
  amount: Number(record.amount || 0),
  currency: ["EUR", "MXN", "USD"].includes(record.currency) ? record.currency : "EUR",
  payer: record.payer === "jose" ? "jose" : "maria",
  created_at: record.created_at || ""
});
...
const loadRemoteExpenses = async ({ seedLocal = false } = {}) => {
  if (remoteExpensesBusy) return;
  try {
    remoteExpensesBusy = true;
    const rows = await remoteSelect("expenses");
    remoteOnline = true;
    const localOnly = seedLocal && Array.isArray(rows) ? expenses.filter(expense => !isUuid(expense.id)) : [];
    if (localOnly.length) {
      const seeded = [];
      for (const expense of localOnly) {
        const created = await remoteInsert("expenses", toExpenseRecord(expense));
        if (created) seeded.push(fromExpenseRecord(created));
      }
      expenses = [...seeded, ...rows.map(fromExpenseRecord)];
    } else if (Array.isArray(rows)) {
      expenses = rows.map(fromExpenseRecord);
    }
    renderExpenses();
  } catch {
    remoteOnline = false;
  } finally {
    remoteExpensesBusy = false;
  }
};
const saveExpenseRemote = async payload => {
  if (remoteOnline) {
    const created = await remoteInsert("expenses", toExpenseRecord(payload));
    if (created) return fromExpenseRecord(created);
  }
  return { id: localId(), ...payload };
};
const updateExpenseRemote = async (id, payload) => {
  if (remoteOnline && isUuid(id)) {
    const updated = await remoteUpdate("expenses", id, toExpenseRecord(payload));
    if (updated) return fromExpenseRecord(updated);
  }
  return { id, ...payload };
};
const deleteExpenseRemote = async id => {
  if (remoteOnline && isUuid(id)) await remoteDelete("expenses", id);
};
...
expenseForm.addEventListener("submit", async event => {
  ...
  const payload = { title, amount, currency: expenseCurrency.value, payer: expensePayer.value };
  saveExpense.disabled = true;
  try {
    if (expenseId.value) {
      const saved = await updateExpenseRemote(expenseId.value, payload);
      expenses = expenses.map(item => item.id === expenseId.value ? saved : item);
    } else {
      const saved = await saveExpenseRemote(payload);
      expenses.unshift(saved);
    }
    resetExpenseForm();
    renderExpenses();
  } catch {
    saveExpense.textContent = "Error, intenta otra vez";
    setTimeout(() => { saveExpense.textContent = expenseId.value ? "Guardar cambios" : "Agregar gasto"; }, 1200);
  } finally {
...
renderExpenses();
loadRemoteExpenses({ seedLocal: true });
setInterval(() => loadRemoteExpenses(), 8000);
